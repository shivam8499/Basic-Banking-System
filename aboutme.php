...
.icon-bar {
  position: relative;
  top: 80px; left: 475px; width: 50px;
  border-radius:100px;
...
<body style= background-image:url(img/bg.jpg);>
	...
	<ul >
			...
			<div id="main">
				...
				<h2 style="position:relative; left: 150px; font-family: 'Poppins',sans-serif; text-shadow: 3px 2px 5px grey;">SHIVAM AGARWAL</h2>
				...
				0 32px 64px -48px rgba(0,0,0,0.5); " src="img/pkn.jpg"></centre>
...
<a href="https://www.facebook.com/shivam8499/" class="facebook"><i class="fa fa-facebook"></i></a>
  <a href="https://www.instagram.com/its_shivam_a/" class="instagram"><i class="fa fa-instagram"></i></a>
  <a href="https://www.linkedin.com/in/shivam-agarwal-8a6881148/" class="linkedin"><i class="fa fa-linkedin"></i></a>
</div>
</body>
</html>